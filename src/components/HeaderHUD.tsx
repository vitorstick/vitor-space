  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-0 z-30 p-4 md:p-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 md:flex-row md:items-start md:justify-between">
        {/* Left Branding & Title */}
        <div className="pointer-events-auto flex flex-col gap-2 rounded-xl border border-[#232f1e]/80 bg-[#0a0d09]/85 p-4 backdrop-blur-md shadow-[0_4px_24px_rgba(0,0,0,0.6)]">
          ...
          <h1 className="text-xl md:text-2xl font-bold tracking-tight text-white uppercase">
            Topographical Portfolio
          </h1>

          <p className="text-xs font-mono text-slate-300/80 max-w-md">
            Staff & Senior Frontend Engineer • Hybrid Mobile & Web Architecture • Technical Articles
          </p>
        </div>

        {/* Right Telemetry Controls & Filters (Shown on Timeline Page) */}
